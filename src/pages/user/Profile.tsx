    ...
    <AppLayout title="Profile">
      <div className="space-y-6 animate-fade-in">
        ...
        <div className="bg-dark-card border border-dark-border rounded-2xl p-6 text-center">
          ...
          <p className="text-sm text-[#8B8B9E] capitalize">{user?.role}</p>
        </div>

        {/* Edit Email */}
        <div className="bg-dark-card border border-dark-border rounded-2xl p-4">
          <h3 className="text-sm font-medium text-[#8B8B9E] mb-4">Email Settings</h3>
        ...
        {/* Change Password */}
        <div className="bg-dark-card border border-dark-border rounded-2xl p-4">
          <h3 className="text-sm font-medium text-[#8B8B9E] mb-4">Password Settings</h3>
          <Button
